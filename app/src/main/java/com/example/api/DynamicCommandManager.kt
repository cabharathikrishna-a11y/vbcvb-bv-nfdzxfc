                ...
                if (task.isSuccessful) {
                    ...
                    kotlinx.coroutines.CoroutineScope(kotlinx.coroutines.Dispatchers.IO).launch {
                        try {
                            ...
                            if (mappedAction == "START" && (statusStr.equals("Focusing", ignoreCase = true) || statusStr.equals("Running", ignoreCase = true) || statusStr.equals("Studying", ignoreCase = true))) {
                                PeerFocusFcmNotifier.notifyFriendsOnFocusStart(context, email, currentTask, currentTag, sessionId)
                            } else if (mappedAction == "END" || mappedAction == "SESSION_END" || statusStr == "IDLE") {
    ...
    fun calibrateLocalState(
        ...
        try {
            ...
            val focusMinsSetting = context.getSharedPreferences("app_prefs", Context.MODE_PRIVATE)
                .getSafeInt("pomodoro_focus_duration_mins", 25)
                ...
                when (statusStr.lowercase()) {
                    ...
                    "break" -> {
                        ...
                        val breakMins = context.getSharedPreferences("app_prefs", Context.MODE_PRIVATE)
                            .getSafeInt("stopwatch_break_duration", 5)
