...
val MIGRATION_33_34 = object : Migration(33, 34) {
    override fun migrate(database: SupportSQLiteDatabase) {
        try {
            database.execSQL("CREATE TABLE IF NOT EXISTS `chat_messages` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `sender_id` TEXT NOT NULL, `text` TEXT NOT NULL, `status` TEXT NOT NULL, `created_at` TEXT, `reactions` TEXT NOT NULL, `is_pinned` INTEGER NOT NULL, `reply_to_id` INTEGER, `reply_to_text` TEXT, `reply_to_sender` TEXT, `type` TEXT NOT NULL, `content_url` TEXT, `local_path` TEXT, `file_name` TEXT, `file_size_kb` INTEGER, `mime_type` TEXT, `duration_sec` INTEGER, `timestamp` INTEGER NOT NULL)")
        } catch (e: Exception) {
            e.printStackTrace()
        }
        try {
