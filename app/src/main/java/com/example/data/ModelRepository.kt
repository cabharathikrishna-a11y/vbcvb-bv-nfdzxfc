...
object ModelRepository {
    ...
    val FLAGSHIP_QWEN_CODER = LocalAiModel(
        id = "qwen2_5_coder_1_5b",
        name = "Qwen 2.5 Coder 1.5B Instruct (GGUF Q4_K_M)",
        ...
        recRamGb = 4.0,
        minStorageGb = 1.3,
        description = "Advanced offline coding, system automation, reasoning & natural language control for all Life OS features.",
        category = "Flagship Offline AI"
    )
